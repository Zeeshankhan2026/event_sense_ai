...
print(eventModel.eventStartDate);
print(eventModel.eventEndDate);
print(eventModel.eventLocation);
print(eventModel.eventBudget);
print(eventModel.eventDescriptions);
print(eventModel.eventId);
print(eventModel.eventType);
  ...
  late List<AiGenerateCards> aiGenerateCard = [
    AiGenerateCards(
      voidCallback: () {
        Get.toNamed(AppRoutes.vendersManagement, arguments: eventModel);
      },
    ...
    AiGenerateCards(
        voidCallback: () {
          Get.toNamed(AppRoutes.createInvitaionCardDesign, arguments: eventModel);
        },
    ...
    AiGenerateCards(
        voidCallback: () {
          Get.toNamed(AppRoutes.guestList, arguments: eventModel.eventId);
        },
    ...
    AiGenerateCards(
        voidCallback: () {
          Get.toNamed(AppRoutes.budgetBreakdown, arguments: eventModel);
        },
                  ...
                  children: [
                    ...
                    StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // Update AI Cards tags if data is available
                        if (aiGenerateCard.length > 2) {
                          aiGenerateCard[2] = aiGenerateCard[2].copyWith(
                            tag:
                                "$acceptedCount / $totalInvited Confirmed Guests",
                          );
                        }
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: BudgetUsedCard(
                                      used: eventModel.eventBudget,
                                      total: eventModel.eventBudget,
                                    ),
                                  ),
                                ],
                              ),
